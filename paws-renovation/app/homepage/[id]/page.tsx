          ...
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                platform is designed to provide students with easy access to the
                information they need to stay on top of their academic goals.
                Whether you need to check your class schedule, view your
                financial aid status, or access your grades, PAWS has you
                covered. With PAWS, you can stay organized, manage your academic
                journey, and stay on top of your goals with ease.
              </p>
              <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                <div key="Holds" className="relative pl-9">
                  ...
                  <dd className="inline">
                    {holds.length == 0
                      ? "You currently do not have any To Dos!"
                      : holds.map((hold) => hold.description).join(", ")}
                  </dd>
                </div>
